...
namespace DepartmentChat.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public IndexModel(
            ...
            SignInManager<DepartmentUser> signInManager)
        {
        ...
        private async Task LoadAsync(DepartmentUser user)
        {
