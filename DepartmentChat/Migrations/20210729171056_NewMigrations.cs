    ...
    public partial class NewMigrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatsUser", x => new { x.AspNetUsersId, x.ChatsId });
                    table.ForeignKey(
                        name: "FK_ChatsUser_AspNetUsers_AspNetUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentMessages_Messages_MessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatsUser_ChatsId",
                table: "ChatsUser",
                column: "ChatsId");

            migrationBuilder.CreateIndex(
                name: "IX_ContentMessages_MessageId",
                table: "ContentMessages",
                column: "MessageId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Groups_ChatsId",
                table: "Groups",
                column: "ChatsId",
                unique: true);
